...
def get_info():
    ...
    return {
        ...
        "functions": {
            ...
            "colliders": {
                "url": "https://github.com/networkx/nx-parallel/blob/main/nx_parallel/algorithms/dag.py#L29",
            ...
            "v_structures": {
                "url": "https://github.com/networkx/nx-parallel/blob/main/nx_parallel/algorithms/dag.py#L11",
